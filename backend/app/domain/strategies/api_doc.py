...
class ApiDocumentStrategy:
    ROLES = [
        SemanticRole.DEFINITION,
        SemanticRole.API_INPUT,
        SemanticRole.API_OUTPUT,
        SemanticRole.ERROR_CODE,
    ...
    def type(self) -> KnowledgeType:
        return KnowledgeType.API_DOCUMENT
    ...
    def build_units(self, context: DocumentContext) -> list[KnowledgeUnitDraft]:
        return extract_units_from_text(
            ...
            knowledge_type=KnowledgeType.API_DOCUMENT,
        )

    def plan(self, query: QueryContext) -> RetrievalPlan:
        roles = [SemanticRole.DEFINITION, SemanticRole.API_INPUT, SemanticRole.API_OUTPUT, SemanticRole.EXAMPLE]
        if query.intent == QueryIntent.RISK:
            roles = [SemanticRole.ERROR_CODE, SemanticRole.CONSTRAINT]
        return RetrievalPlan(
            ...
            steps=[
                {"type": "keyword_search", "terms": query.topics},
    ...
    def check_completeness(
        ...
        return CompletenessResult(
            ...
            need_secondary_retrieval=score < 0.9,
